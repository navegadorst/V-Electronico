...
//[assembly: OwinStartup(typeof(ValeElectronico.Startup))]

namespace ValeElectronico
{
    public class StartupV1
    {
        ...
        string redirectUri = System.Configuration.ConfigurationManager.AppSettings["ida:PostLogoutRedirectUri"];
